...
Route::get('/Admin/modal/plan', [App\Http\Controllers\ProjectController::class, 'plansModal'])->name('plan.modal');
...
Route::get('/Admin/modal/team', [App\Http\Controllers\TeamController::class, 'team'])->name('team.modal');
...
Route::get('/Admin/modal/Service', [App\Http\Controllers\ServiceController::class, 'service'])->name('service.modal');
...
Route::get('/Admin/modal/projects', [App\Http\Controllers\ProjectController::class, 'projects'])->name('projects.modal');
...
Route::get('/Admin/modal/modernplans', [App\Http\Controllers\ModelProjectController::class, 'projects'])->name('ModernProjects.modal');
