...
<head>
    ...
    <meta property="og:image" content="{{ $projectimage ? asset('image/' . $projectimage->image) : '' }}">
<link rel="icon" href="{{ $projectimage ? asset('image/' . $projectimage->image) : '' }}" type="image/x-icon">
